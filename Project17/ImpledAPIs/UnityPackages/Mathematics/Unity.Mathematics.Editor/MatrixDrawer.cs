...
namespace Unity.Mathematics.Editor
{
    ...
    class MatrixDrawer : PropertyDrawer
    {
        ...
        void DoUtilityMenu(SerializedProperty property)
        {
			...
			GUIContent content = new GUIContent("pj17_content"), content2 = new GUIContent("pj17_content2");
			content.text = "Set to Zero";
			content2.text = "Reset to Identity";
            menu.AddItem(
				content,
                //new GUI.Text("Set to Zero"),
                false,
                () =>
                {
