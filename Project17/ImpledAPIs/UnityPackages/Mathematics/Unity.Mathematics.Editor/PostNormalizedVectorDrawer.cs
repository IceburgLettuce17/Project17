    ...
    class PostNormalizedVectorDrawer : PrimitiveVectorDrawer
    {
        static class Content
        {
            public static readonly string tooltip =
                "Values you enter will be post-normalized. You will see the normalized result if you change selection and view the values again.";
        }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (!guiData.Valid)
            {
                EditorGUI.HelpBox(
                    ...
                    $"{typeof(PostNormalizeAttribute).Name} only works with decimal vector types.",
                    MessageType.None
                );
                return;
            }
