...
namespace Unity.Mathematics
{
    ...
    static public class svd
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void condNegSwap(bool c, float3 x, float3 y)
        {
            var tmp = -x;
            x = math.select(x, y, c);
            y = math.select(y, tmp, c);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void sortSingularValues(float3x3 b, quaternion v)
        {
        ...
        static quaternion jacobiIteration(float3x3 s, int iterations = 5)
        {
            float3x3 qm;
            quaternion q;
        ...
        static float3 singularValuesDecomposition(float3x3 a, out quaternion u, out quaternion v)
        {
            ...
            float3x3 e; u = givensQRFactorization(b, out e);
        ...
        {
			quaternion u,v;
            var e = singularValuesDecomposition(a, out u, out v);
